...
/**
 * Metoda koja poredi karte koje je igrac odabrao za otvaranje odnosno zza zavrsetak igre
 * Provjerava ispravnost odabira karata od strane igraca
 * @param arr prima niz indexa karti koje je igrac odabrao
 * @param p igrac koji je na potezu
 * @return vraca true ili false ovisnosti o tome da li je igrac izabrao ispravne karte ili ne
 */
	...
	/**
	 * Metoda koja sluzi da korisnik baci kartu iz spila
	 * Ta karta se sprema u novi spil
	 * @param p igrac koji je na potezu
	 */
	...
	/**
	 * Metoda koja daje kartu igracu iz spila
	 * @param p igrac koji je na potezu
	 */
